...
import com.steve.train.business.domain.DailyTrainSeat;
import com.steve.train.business.domain.DailyTrainTicket;
import com.steve.train.business.enums.ConfirmOrderStatusEnum;
import com.steve.train.business.feign.MemberFeign;
import com.steve.train.business.mapper.ConfirmOrderMapper;
import com.steve.train.business.mapper.DailyTrainSeatMapper;
import com.steve.train.business.mapper.custom.DailyTrainTicketMapperCustom;
...
public class AfterConfirmOrderService {
    ...
    public void afterDoConfirm(DailyTrainTicket dailyTrainTicket, List<DailyTrainSeat> finalSeatList, List<ConfirmOrderTicketReq> tickets, ConfirmOrder confirmOrder) throws Exception {
        ...
        for (int j = 0; j < finalSeatList.size(); j++) {
            ...
            // 最大的区间开始值，不能超过本次的 endIndex
            Integer maxStartIndex = endIndex - 1;
            Integer minEndIndex = startIndex + 1;
            Integer minStartIndex = 0;
            // 最小的区间开始值，应该是当前起 startIndex, 往前找，一起找到是前面1的最后一个 0
